#include "cbw36_ps7_pub_des_state.h"
...
void DesStatePublisher::initializeSubscribers() {
    alarm_subscriber_ = nh_.subscribe("/scan", 1, &DesStatePublisher::alarmCB, this); // Modified by Jonathan
    //dist_subscriber_ = nh_.subscribe("lidar_dist", 1, &PS6DesStatePublisher::alarmCB, this); // Modified by Jonathan
    ESTOP_ = nh_.subscribe("/ESTOP", 1, &DesStatePublisher::estopCB, this); // Modified by Jonathan
}
...
void DesStatePublisher::estopCB(const std_msgs::Bool& estop_msg) 
{ 

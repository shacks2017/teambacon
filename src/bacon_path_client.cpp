...
int main(int argc, char **argv) {
    ...
    pose_stamped.pose.position.x = 9.0; 
    pose_stamped.pose.position.y = 7.0;
    path_srv.request.nav_path.poses.push_back(pose_stamped);

    pose_stamped.pose.position.x = 3.0; 
    pose_stamped.pose.position.y = 8.0;
    path_srv.request.nav_path.poses.push_back(pose_stamped);

    pose_stamped.pose.position.x = 1.0; 
    pose_stamped.pose.position.y = 8.5; //changed from 9
    path_srv.request.nav_path.poses.push_back(pose_stamped);

    pose_stamped.pose.position.x = 1.0; 
    pose_stamped.pose.position.y = 14.0;
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    ...
    //pose.position.x = 7.0; // say desired x-coord is 1
    //pose.position.y = 4.0;
    //path_srv.request.nav_path.poses.push_back(pose_stamped);

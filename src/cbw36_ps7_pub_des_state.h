...
#include <queue>
#include <cbw36_ps7_traj_builder/cbw36_ps7_traj_builder.h> //has almost all the headers we need
...
private:
    ...
    void estopCB(const std_msgs::Bool& estop_msg);

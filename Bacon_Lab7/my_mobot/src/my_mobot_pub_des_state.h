...
#include <queue>
#include<lab7_traj_builder/lab7_traj_builder.h> //has almost all the headers we need
...
private:
    ...
    bool appendPathQueueCB(my_mobot::pathRequest& request,my_mobot::pathResponse& response);

...
nav_msgs::Odometry current_odom_11;
...
void SteeringController::lin_steering_algorithm() {
    ...
    odom_x_ = current_odom_11.pose.pose.position.x;
    odom_y_ = current_odom_11.pose.pose.position.y;
    odom_quat_ = current_odom_11.pose.pose.orientation;
...
{ 
    ...
    while (ros::ok()) {
        ...
        current_odom_11=OdomTf.current_odom_1;

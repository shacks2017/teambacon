...
int main(int argc, char **argv) {
    ...
    double speed = 0.33; // 0.33 m/s speed command - adjusted from original program
    double yaw_rate = 0.523; //0.5 rad/sec yaw rate command
    double time_3_sec = 3.0; // should move 1 meters or 1.5 rad in 3 seconds
    ...
    twist_cmd.angular.z=yaw_rate*1.4; //and start spinning in place
